...
class TestStaticStations:
    ...
    def _get_item(self, name: str) -> pd.DataFrame:
        static_stations = pd.read_csv(self.output_file_path).assign(
    ...
    def test_stations_id_not_duplicated(self):
        ...
        for row in items:
            assert (
                set(row.stationsId_one.split(";"))
                & set(row.stationsId_three.split(";"))
                == set()
            )
            assert (
                set(row.stationsId_three.split(";"))
                & set(row.stationsId_five.split(";"))
                == set()
            )
    ...
    def test_stations_medolago(self):
        ...
        assert (
            item["stationsId_three"]
            == "50176;38229;54369;55055;25303;11431;39057;26246;36373;15828"
        )
        assert (
            item["stationsId_five"]
            == "46031;54900;4644;33398;48550;54373;11306;15311;43387;50286;16552;11253;51452"
        )
